...
F.res1       = ProtoField.uint32("lifx.reserved1" , "Reserved (1)"  , base.HEX)
F.targetAddr = ProtoField.bytes("lifx.targetAddr" , "Target address", base.HEX)
F.res2       = ProtoField.uint16("lifx.reserved2" , "Reserved (2)"  , base.HEX)
F.site       = ProtoField.bytes("lifx.site"       , "Site address"  , base.HEX)
F.res3       = ProtoField.uint16("lifx.reserved3" , "Reserved (3)"  , base.HEX)
...
F.res4       = ProtoField.uint16("lifx.reserved4" , "Reserved (4)"  , base.HEX)
...
F.res5       = ProtoField.uint16("lifx.reserved5" , "Reserved (5)"  , base.HEX)
